    ...
    <div className="inline-flex flex-wrap gap-2">
      ...
      <a href="https://accounts.google.com" target="_blank" rel="noopener noreferrer">
        <Button
          ...
          size="icon"
          className="w-12 h-12 bg-orange-500 border-orange-500 text-white hover:bg-orange-600 hover:border-orange-600 transition-all duration-200 hover:scale-105"
        >
